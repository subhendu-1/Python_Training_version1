...
class Product(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)  # ✅ Auto-incrementing ID
    name = db.Column(db.String(80), nullable=False, index=True)  # ✅ Indexed for better search speed
    price = db.Column(db.Float, nullable=False)
    description = db.Column(db.String(200), nullable=True)
    quantity = db.Column(db.Integer, nullable=False, default=0)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)  # ✅ Track product creation date
